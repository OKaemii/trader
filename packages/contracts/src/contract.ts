...
export type InferRequest<C> = C extends InternalContract<infer Req, ZodTypeAny | undefined, ZodTypeAny | undefined>
    ? Req extends ZodTypeAny ? z.infer<Req> : void
    : void;

export type InferResponse<C> = C extends InternalContract<ZodTypeAny | undefined, infer Res, ZodTypeAny | undefined>
    ? Res extends ZodTypeAny ? z.infer<Res> : void
    : void;

export type InferParams<C> = C extends InternalContract<ZodTypeAny | undefined, ZodTypeAny | undefined, infer P>
 ...
 * narrowed schema types rather than a widened `InternalContract<ZodTypeAny, ZodTypeAny, ZodTypeAny>`.
 */
export const defineContract = <
    Req extends ZodTypeAny | undefined = undefined,
    Res extends ZodTypeAny | undefined = undefined,
    Params extends ZodTypeAny | undefined = undefined,
>(c: InternalContract<Req, Res, Params>): InternalContract<Req, Res, Params> => c;
