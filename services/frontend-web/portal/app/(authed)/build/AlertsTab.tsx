...
import { AlertsView, type AlertRule } from '@/components/AlertsView'

// Alerts tab (Build workspace, IA-redesign Task 9) — the body of the old /alerts page verbatim:
// price-alert rules (manual + auto-derived from trade-plan stops/targets). The whole point of swing
// trading is not watching the screen, so a crossed level pushes to the phone. Rendered only when
// this tab is active, so this is the only authedFetch that runs for the tab.
export async function AlertsTab() {
